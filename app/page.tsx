    ...
    <div className="space-y-8">
      ...
      <div className="mt-8 rounded-lg bg-white p-8 shadow-sm ring-1 ring-gray-900/5">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link
            href="/users/new"
            className="flex items-center justify-center rounded-lg px-6 py-4 text-base font-semibold text-white shadow-sm transition hover:opacity-90"
          ...
          <Link
            href="/users"
            className="flex items-center justify-center rounded-lg bg-white px-6 py-4 text-base font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50"
            style={{ borderColor: '#5ce1e680' }}
          >
            View All Users
          </Link>
          <Link
